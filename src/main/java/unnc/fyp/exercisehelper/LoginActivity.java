...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if(!checkUser(email, password)){
            cancel = true;
            focusView = mPasswordView;
            Toast.makeText(this, "Wrong user information", Toast.LENGTH_SHORT).show();
        ...
        if (cancel) {
            ...
            //int j = repo.login(Email,Password);
            //i.putExtra("ID",String.valueOf(j));

            Bundle b = new Bundle();
            b.putString("ID", email);
            i.putExtras(b);
            startActivity(i);
    ...
    private boolean checkUser(String e, String p){
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        String password_get = "";
        String table = "User";
        String[] columns = new String[] {"password"};
        String selection = "username=?";
        String[] selectionArgs = new String[] {e};
        String groupBy = null;
        String having = null;
        String orderBy = null;
        ...
        cursor.close();
        if ( p.equals(password_get)) return true;
        return false;
    }
